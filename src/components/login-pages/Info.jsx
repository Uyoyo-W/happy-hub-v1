    ...
    <div className='info'>
        <div className='info-container'>
            ...
            <form>
                ...
                <select name="months" className='month date'>
                ...
                <select name="cars" className='day date'>
                ...
                <select name="years" className='year date'>
                ...
                <div className='radio radio-male'>
                    <label htmlFor='male'>Male</label>
                    <input type="radio" name='male' id='male'></input>
                </div>
                <div className='radio radio-female'>
                    <label htmlFor='female'>Female</label>
                    <input type="radio" name='female' id='female'></input>
                </div>
            </form>
            <Link to="/Contact" className='info-link'><button className='info-btn'>Continue</button></Link>
        </div>
    </div>
